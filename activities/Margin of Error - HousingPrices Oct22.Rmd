...
Sample Size 100 Margin of Error: 10%
Sample Size 800 Margin of Error: 3.54%
...
The headline 'Majority Supports New City Policy' is not statistically justified since the statistics show how it falls below 50% when we reach the lower Margin of Error. Using the Margin of Error we can see how if we include the margin of errors in each sample size, we see how they can fall below 50% (low MOE for sample size 100).

An alternative headline could be: Close Results for the New City Policy Show How People Really Feel About the Change
...
Local officials claim the transit line has caused an increase in home sale prices in the surrounding area, and new data supports this claim. Before the transit line came in place the average of home prices were $285,000. Once the transit line was constructed the average home price increased to $304,500. Statistical data shows how the p- value 0.0000181 shows a high level of significance.
One reason for this price increase could be due to the possibility of access to businesses and more public spaces that were not easily accesible prior to the transit line.
