...
This chart shows the car theft rates from 2017 to 2025 per 100000 people. We can see that there is a steady fluctuation from 2017 to 2022 of about 20-30 car thefts per 100,000 . Towards the later quater of 2022 through 2023 there is a sharp increase in the car thefts of around 50-60 thefts per 100000 people. Following 2023 the crime rates fall and lower, but is still higher compared to the pre strike years.

After a 2023 Surge, Car Theft Rates Stay Alarmingly High Compared to Previous Years
...
- **Null Hypothesis (H0)**:   The average theft rates are the same across all time periods.

- **Alternative Hypothesis (H1)**: The average theft rates differ across time periods.
...
The F-value is 218 and the p value is less than 0.05, meaning the alternative hypothesis is correct. The result is significant and is not due to random chance
...
The Tukey test results indicate that mean theft rates differ significantly across all three time periods. The spike year recorded the highest theft rate, which was significantly higher than both the pre-spike and post-spike periods. Although theft rates declined after the spike year, the post-spike period still shows levels significantly above those of the pre-spike period. These differences are supported by the chart, which also show non-overlapping 95% confidence intervals between the pre-spike and post-spike periods.

Spike in Car Thefts Shows Signs of Change, But Not Back to Normal

Car theft rates have declined from their 2023 highs, yet current rates remain above pre-spike levels.