...
```{r}
GDP <- read.csv("https://raw.githubusercontent.com/dwillis/jour405/refs/heads/main/data/gdp_djia.csv")
```
...
GDP |> 
  ...
  geom_smooth(aes(x=DJIA, y=DJIA), method="lm")
labs(title = "DJIA v GDP", x = "DJIA", y = "GDP")
...
Based on the scatterplot, we can see that the two variables have a positive relationship as when DJIA increases so does GDP. The two variables also have a strong positive corelation with 0.953. Though told through the code, the scatterplot also shows this since many of the points are near the blue line. 
